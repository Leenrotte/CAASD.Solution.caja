...
{
    public class ReporteAveriaRepository : Repository<ReporteAveria>, IReporteAveriaRepository
    {
        public ReporteAveriaRepository(CaasdCoreDbContext context) : base(context) { }
